...
import { BookOpen, Sparkles, ChevronLeft, Copy, Check, Wand2, Film, Users, Baby, Mic, X, Settings, Image as ImageIcon, Video, KeyRound, ExternalLink, AlertTriangle } from "lucide-react";
...
const STAR_PATH =
  "M50 4 L61 35 L94 35 L67 55 L78 88 L50 68 L22 88 L33 55 L6 35 L39 35 Z";

function EightStar({ size = 22, className = "", spin = false }) {
  return (
    <svg
      width={size}
      height={size}
